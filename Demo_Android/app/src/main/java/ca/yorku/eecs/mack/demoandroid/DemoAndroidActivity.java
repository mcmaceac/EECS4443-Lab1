 ...
 *
 * This is the first in a series of demo programs for the course Mobile User Interfaces (EECS 4443), which is offered in
 ...
 * (EECS 3461), which teaches GUI programming using Java/Swing.<p>
 *
 * In the lectures supporting this demo program, the basic structure and lifecycle of an Android application are
 * discussed. The lectures will also present and discuss the operation of Android Studio, which is the integrated
